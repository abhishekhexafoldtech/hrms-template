            ...
            <OrganizationLayout>
                <div class="policy-container">
                    <div>
                        <div v-for="policy in policiesForm" class="policy-main" :key="policy.id">
                                ...
                                <div class="d-flex w-100" v-if="policy.title">
                                    ...
                                    <div class="d-flex" v-if="user">
                                        ...
                                        <i class="fa fa-check-square-o mx-2 mt-1 cursor-pointer" aria-hidden="true"
                                            ...
                                            @click="handleCorrection('title')"></i>
                                    </div>
                                    <div v-if="user"
                                        ...
                                        <i class="fa fa-trash-o cursor-pointer" aria-hidden="true"
                                            style="color: #bf4040;font-size:16px"
                                            @click="handleDelete(policy.id, 'title')"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="sub d-flex" v-if="policy.sub_title">
                                ...
                                <div v-if="user"
                                    ...
                                    <i class="fa fa-trash-o cursor-pointer" aria-hidden="true"
                                        style="color: #bf4040;font-size:16px" @click="handleDelete(policy.id, 'sub')"></i>
                                </div>
                            </div>
                            <div class="content" v-if="policy.content">
                                ...
                                <div v-if="user">
                                    ...
                                    <i class="fa fa-check-square-o mx-1 mt-1 cursor-pointer" aria-hidden="true"
                                        ...
                                        @click="handleCorrection('content')"></i>
                                </div>
                                <div v-if="user" class="mt-2  w-100" style="display: flex;gap:10px;justify-content: end;">
                                    <i class="fa fa-pencil-square-o cursor-pointer" aria-hidden="true"
                        ...
                        <div v-if="user" class="container form">
                            <el-form :form="policiesFillForm">
                                ...
                                <div class="w-100" style="text-align: right;">
                                    <el-button class="btn btn-primary mt-5" type="primary" :disabled="!formFilled"
                                        @click="handleSave">
                                        Save
                                    </el-button>
                                </div>
