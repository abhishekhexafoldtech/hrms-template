        ...
        <div class="employee-profile-card profile-card background shadow border w-100" style="text-align: center;">
          ...
          <div class="payslips mt-4 w-95" style="margin-bottom: 18px;">
            ...
            <div class="d-flex mx-3 py-2 justify-content-between w-95" v-for="item in 3" :key="item">
              <div class="d-flex">
                <div class="mt-0 p-2 rounded-3" style="width:45px;height:50px;background-color: rgba(239, 243, 249, 1);">
                  <i class="fa fa-file-pdf-o mt-1" aria-hidden="true" style="color:red;font-size:22.7px"></i>
                </div>
          ...
          <div class="organization-chart py-3 my-2 w-95">
            ...
            <div class="organization rounded-3 w-100 mx-2 mt-2 text-start d-flex justify-content-between"
              v-for="user in 3" :key="user">
              <div class="d-flex">
              ...
              <div class="mt-4" style="margin-right: 15px;">
                <i class="fa fa-long-arrow-up" aria-hidden="true"
                  :style="allUsers[user].profession?.startsWith('senior') ? 'color:red' : 'color:green'"></i>
              </div>
            </div>
          </div>
        </div>
