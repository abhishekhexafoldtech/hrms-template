  ...
  <div>
    ...
    <div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6">
      <div class="d-flex w-100 m-2">
        <div class="user_name "><h3>Welcome Vairagi !</h3></div>
      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="row ">
            <div class="col-lg-4">
              <StatisticsCard class="w-100 border" :leave="false" header="Working Remotely" :users="allUsers" description="Employees working remotely."/>
            </div>
            <div class="col-lg-4">
              <StatisticsCard class="w-100 border"  :leave="false" header="On Leave Today" :users="allUsers" description="Employees on Leave today."/>
            </div>
            <div class="col-lg-4">
              <StatisticsCard class="w-100 border"  :leave="false" header="Projects Completed" :users="allUsers" description="Projects completed"/>
            </div>
          </div>
