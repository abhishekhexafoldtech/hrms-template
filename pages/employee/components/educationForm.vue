<template>
  <div>
    <div class="title_flex mb-15">
      ...
      <el-button class="add_btn" @click="incrementEducation"
    ...
    <div class="title_flex m-0" v-if="educationFormData.length > 1">
      <span></span>
      <el-button class="add_btn" @click="decrementEducation"
...
const educationFormRules = ref({
  ...
  college_name: [
    { required: true, message: "Please enter college name", trigger: "blur" },
  ],
  university_name: [
    {
      required: true,
