        ...
        >
            <el-row :gutter="10">
                <el-col :xs="8" :sm="8" :lg="8" :xl="8">
                    <el-form-item label="Occation" prop="name">
...
const formValidationRules = reactive({
    name: [
        {
        required: true,
        message: "Please enter the occation",
        trigger: "blur",
        },
    ],
    startDate: [
        {
        required: true,
        message: "Please enter start day of occation",
        trigger: "blur",
        },
    ],
    endDate: [
        {
        required: true,
        message: "Please enter end day of occation",
        trigger: "blur",
        },
    ],
})
...
onMounted(()=>{
    ...
    if(router.holidayData){
        formData.name = router.holidayData.occation;
        formData.startDate = router.holidayData.start_date;
        formData.endDate = router.holidayData.end_date;
        formData.description = router.holidayData.description;
